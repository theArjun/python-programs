...
# Step 3: Define a function with a temporary function as paramter; give whatever name you like.
def add_html_formatting(tempFunction):
    # Step 4: Define another function with the same paramter to wrap the defined function at step 1.
