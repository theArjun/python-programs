...
driver.find_element_by_xpath("/html/body/div[1]/div/div/div[1]/div[2]/div[3]/div[1]/div[1]/div/div/div[2]/div/ul/li[3]/div[1]/a/div/div[1]/div/div/div/div/img").click()

active_status = driver.find_element_by_css_selector("._2v6o").text
if active_status == 'Active now':
    # CSS selector for voice call
    driver.find_element_by_css_selector("._fl2 > li:nth-child(1) > a:nth-child(1) > div:nth-child(1) > svg:nth-child(1)").click()
