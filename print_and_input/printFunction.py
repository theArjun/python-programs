...
# This is how we print the value of multiple variables using comma operator
# inside the print function.
print("Name = ", name, "Marks = ", marks)

# This is how we print the value of strings and integers using format
# specifier and format specifier for the numeric data also can shorten or
# longen the data.
